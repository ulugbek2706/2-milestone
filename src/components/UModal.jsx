...
export default function UModal(props){
          ...
          <TEModalContent>
            ...
            <TEModalBody>
                ...
                {props.elements.map((item, index)=>
                    item.data?item.data: <div key={index}>
                    <label className="d-flex gap-2 fs-5">
                        {item?.name + ':'}
                        <input
                            className="block w-full px-4 py-2 mt-2 text-gray-900 placeholder-gray-500 border rounded-lg border-slate-500 focus:ring focus:ring-blue-300"
                            type={item.type}
