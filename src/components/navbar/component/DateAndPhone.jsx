...
function DateAndPhone(props) {
    ...
    return (
        <div className={"flex item-center justify-between gap-2 px-2"}>
            {data && (
            ...
            <div className={"my-auto px-1"}>
                <select
                    className={" block scale-110 w-full rounded-md  shadow-sm focus:border-primary-300 outline-0 focus:ring focus:ring-primary-200 focus:ring-opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50"}
                    defaultValue={selectedLanguage} onChange={handleChange}>
