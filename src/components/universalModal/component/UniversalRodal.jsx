...
const UniversalRodal = (props) => {
    ...
    const {imgFile} = useSelector((state) => state.customerCategory);
                                                            ...
                                                            item.type !== "map" && (
                                                                <div className="mt-[-2px]" key={index}>
                                                                    <label className={"mt-1"}>
                                                                        ...
                                                                        item.type !== "tel" ? (
                                                                            <input
                                                                                className="block px-2 py-2 mr-1 mt-1 text-gray-900 placeholder-gray-500 border rounded-lg border-slate-500"
                                                                                type={item.type}
                                                                    ...
                                                                    {errors[item?.key]?.message && (
                                                                        <span
                                                                            className="error-message text-red-700 text-sm">
                                    {errors[item?.key].message}
                                  </span>
                                                                    )}
                                                                </div>
