...
const UniversalTable = ({data, columns, allData, url, locName}) => {
    ...
    const handleTableActive = (key) => {
        ...
        dispatch(changeTableActive(key));
        dispatch({
            type: "territory/getTerritory",
            payload: {
                pageSize: pageSize,
            ...
            <div>
                {url === "company" ? (
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            onClick={() => handleTableActive(true)}
                            className={` ${
                        ...
                        <button
                            onClick={() => handleTableActive(false)}
                            className={` ${
                ...
                <div>
                    <div>
                        <table className=" text-center text-sm font-light w-full rounded-md">
                            <thead
                                className="border-b border bg-gray-200 text-white font-medium dark:border-neutral-500 dark:bg-neutral-600">
                            <tr>
                    ...
                    {data.length !== 0 && (
                        <div className="w-full min-h-[30px] flex items-center justify-center p-2 text-white">
                            {loading ? (
                                ...
                                <Pagination
                                    disabled={Math.ceil(allData / pageSize) < 2}
                                    color="success"
                                    onChange={(e, page) => {
                                        dispatch({
                                            type: `territory/getTerritory`,
